<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link" >
      <img src="{{asset('media/logo/logo50.png')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <router-link to="/new-student" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>New</p>
                </router-link>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <router-link to="/new-faculty" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>New</p>
                </router-link>
              </li>
              <li class="nav-item">
                <router-link to="/faculty-list" class="nav-link">
                  <i class="fa fa-circle-o nav-icon"></i>
                  <p>List</p>
                </router-link>
              </li>
